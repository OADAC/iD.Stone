...
const CACHE='idstone-explorer-v2';
const SHELL=['./','./index.html','./styles.css','./art.css','./art.js','./assets/orbit.webp','./assets/chair.webp','./assets/basin.webp','./app.js','./assets/hero.webp','./assets/slab.webp','./assets/architecture.webp','./assets/collection.webp'];
